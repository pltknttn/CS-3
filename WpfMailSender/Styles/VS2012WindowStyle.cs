...
namespace WpfMailSender
{
    ...
    public partial class VS2012WindowStyle
    {
        ...
        void MinMaxButtonLoaded(object sender, RoutedEventArgs e)
        {
            if (!(sender is Button but)) return;

            var resizeMode = ResizeMode.CanResizeWithGrip;
            sender.ForWindowFromTemplate(w => resizeMode = w.ResizeMode);
